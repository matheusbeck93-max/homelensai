...
| `source`   | `"header_chip" \| "usage_page" \| "cap_blocker_daily" \| "cap_blocker_monthly" \| "cap_banner" \| "topup_packs" \| "next_tier_compare" \| "console_plan" \| "overview_card" \| "chat_inline"` | Where the event originated.          |
