...
export const SUBSCRIPTION_PLANS: Record<SubscriptionTier, SubscriptionPlan> = {
  free: {
    ...
    features: [
      ...
      'HomeLens chat on any tab (Chrome Extension)',
      'Auto-detect property listings (Chrome Extension)',
      'Chrome Extension analysis — 3x per day',
  ...
  buyer: {
    ...
    features: [
      ...
      'Mortgage Calculator',
      'Buying Power Calculator',
      'Chrome Extension analysis — no daily cap',
