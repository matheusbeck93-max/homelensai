  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img src={heroBackground} alt="Beautiful American home" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white/20 text-white bg-[#da311d]">
                Learn More
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              icon: Icon,
              label
            }) => <Card key={id} className={`cursor-pointer transition-all hover:shadow-lg hover:border-primary/50 ${selectedCategories.includes(id) ? "border-primary bg-primary/5 shadow-md" : ""}`} onClick={() => toggleCategory(id)}>
      ...
      <section id="features" className="py-20 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => <Card key={index} className="border hover:border-primary/50 hover:shadow-lg transition-all group">
            ...
            <Card className="border-2 border-primary shadow-xl">
              <CardContent className="p-12">
                ...
                <ul className="space-y-4 text-left max-w-md mx-auto mb-10">
                  {["Unlimited AI conversations", "Property image analysis", "Market insights and trends", "Mortgage calculators", "Investment analysis tools", "Export conversation history"].map((feature, i) => <li key={i} className="flex items-center gap-3">
