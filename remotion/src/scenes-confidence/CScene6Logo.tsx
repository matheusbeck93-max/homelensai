...
export const CScene6Logo = ({ colors }: Props) => {
  ...
  const ctaOp = interpolate(frame, [30, 48], [0, 1], { extrapolateRight: "clamp" });
  const ctaY = interpolate(spring({ frame: frame - 30, fps, config: { damping: 20 } }), [0, 1], [20, 0]);
    ...
    <AbsoluteFill style={{ fontFamily, opacity: fadeIn, justifyContent: "center", alignItems: "center" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 28, padding: "0 60px" }}>
        ...
        <div style={{
          ...
          fontSize: 26, fontWeight: 500, color: colors.white, textAlign: "center", lineHeight: 1.4,
        }}>
          Smarter home buying{"\n"}starts here.
        </div>
      </div>
