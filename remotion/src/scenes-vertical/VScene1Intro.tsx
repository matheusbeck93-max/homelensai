...
export const VScene1Intro = ({ colors }: Props) => {
    ...
    <AbsoluteFill style={{ fontFamily, opacity: fadeOut, justifyContent: "center", alignItems: "center" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 30 }}>
        ...
        <div style={{ opacity: textOp, transform: `translateY(${textY}px)`, textAlign: "center" }}>
          <div style={{ fontSize: 56, fontWeight: 700, color: colors.white, letterSpacing: -1 }}>HomeLens</div>
          <div style={{ fontSize: 22, color: colors.muted, marginTop: 12 }}>Your AI Home Buying Copilot</div>
        </div>
      </div>
    </AbsoluteFill>
  );
